...
import com.jd.si.jupiter.smart.codec.ThriftFrameCodecFactory;
...
public class ThriftClientDef
{
    ...
    public static ThriftClientDefBuilder newBuilder()
    {
        return new ThriftClientDefBuilder();
    }
